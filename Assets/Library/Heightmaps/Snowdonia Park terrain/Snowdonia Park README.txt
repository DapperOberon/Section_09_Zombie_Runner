...
If you should want to export this again for any reason:
  http://terrain.party/api/export?name=Snowdonia+Park&box=-3.908087,52.956667,-4.027381,52.884802
...
-----------
  ...
  * Snowdonia Park Height Map (ASTER 30m).png
  ...
  * Snowdonia Park Height Map (Merged).png
...
[!] If you look at one height map, look at this one. [!]
  ...
  * Snowdonia Park Height Map (SRTM3 v4.1).png
  ...
  * Snowdonia Park Height Map (SRTM30 Plus).png
...
The SRTM3 v4.1 height map has some missing data.
